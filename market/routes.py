    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Unfortunately, you don't have enough monwy to purchase {p_item_object.name}", category="danger")
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Congratulations! You sold {s_item_object.name}! It is back in the market", category="success")
            else:
